...
namespace ConsoleTables
{
    public class ConsoleTable
    {
        ...
        public string ToStringAlternative(string horizontal)
        {
            var builder = new StringBuilder();
            ...
            // create the divider
            var divider = Regex.Replace(columnHeaders, @"[^|]", horizontal);
        ...
        public void Write(string horizontal, Format format = ConsoleTables.Format.Default)
        {
            switch (format)
            {
                ...
                case ConsoleTables.Format.Alternative:
                    Console.WriteLine(ToStringAlternative(horizontal));
                    break;
        ...
        public string Get(string horizontal, Format format = ConsoleTables.Format.Default)
        {
            switch (format)
            {
                case ConsoleTables.Format.Default:
